...
<header>
    ...
    <!-- Barre de Navigation -->
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="index.php"> Dossiers Geek <span class="sr-only">(current)</span></a>
                        ...
                        <div class="carousel-item <?= $article === $articles[0] ? 'active' : '' ?>">
                            <div class="col-md-4">
                                <div class="card card-body">
                                    ...
                                    <br>
                                    <a href="./Views/read.php?id=<?= $article->getId() ?>" class="btn btn-info">Commentaires</a>
                                    <a href="./Views/update.php?id=<?= $article->getId() ?>" class="btn btn-warning" id="bouton_3">Modifier</a>
                                    <a id="button_delete" class="btn btn-danger" onclick="return confirm('Est-ce que vous voulez réellement supprimer cette article ?');" href="./Views/delete.php?id=<?= $article->getId() ?>">Supprimer</a>
